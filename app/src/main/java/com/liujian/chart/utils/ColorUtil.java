...
public class ColorUtil {
    ...
    //跌颜色
    public static final int COLOR_GREEN = Color.parseColor("#3FC172");
    //涨颜色
    public static final int COLOR_RED = Color.parseColor("#FD4C5F");
    //平灰
    public static final int COLOR_PING_ASH = Color.parseColor("#A3A7B2");
    //平白
     ...
     * @return
     */
    public static int getChangeTextColor(double change) {
        if (change == 0)
